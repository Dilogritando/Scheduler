/* "Este es el rango de fechas que quiero mostrar" */
let dateMin = "2020/01/01";
let dateMax = "2021/01/01";

/* "Esta función me va a ayudar a convertir un string a un objeto formato fecha de JS, con el día que yo le señale" */
...
/* "Esta función contiene toda la carne: va a mostrar en formato calendario el lapso que yo determine" */
...
/* "Con esta operación defino lo que será el contenido que será enviado al dom" */
content = timeLapse(dateMin, dateMax);

/* "Esta operación lleva el contenido al DOM apenas carga la ventana" */
